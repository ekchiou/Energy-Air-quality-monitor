...
Πως μπορώ να δημιουργήσω ένα έξυπνο μετρητή ηλεκτρικής ενέργειας που ανά πάσα στιγμή να μου δείχνει τα KW κατανάλωσης από οποιοδήποτε σημείο μέσω διαδικτύου;
Υπάρχει τρόπος να μετρήσω το CO2 και τους ρύπους στον ατμοσφαιρικό αέρα δίνοντας ανά πάσα στιγμή τα δεδομένα των μετρήσεων στη διάθεση του καθένα;
Θα μπορούσε το σύστημα αυτό να ενημερώνει σε περίπτωση που τα όρια έφταναν σε όρια που χρήζουν προσοχής;
...
Όνομα ομάδας: 
Η ομάδα μας είναι η ECO2-watchers. Το Ε από το Energy consumption. Το
